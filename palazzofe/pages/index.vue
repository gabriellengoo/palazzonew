<template>
  <div class="bgmobile relative min-h-screen"
    ...
    <div :class="{ 'hidden-content': isMenuOpen }" id="main-content" class="flex justify-center pt-[20vh] md:pt-0 lg:pt-0 xl:pt-0 items-start md:items-center lg:items-center xl:items-center h-screen">
      <div class="relative text-center">
        <h1 class="maintext text-5xl lg:text-[6rem] xl:text-[13rem] text-black leading-tight relative z-0">
          PALAZZO EVENTI
        </h1>
      </div>
    </div>

    <HeaderComponent @menu-toggled="isMenuOpen = $event" />
